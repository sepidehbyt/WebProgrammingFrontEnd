            ...
            for (let i = 0; i < 3; i++) {
                ...
                if(star == 4.5 || star == 3.5 || star == 2.5 || star == 1.5 || star == 0.5) {
                    for (let j = 0; j < 5 - star - 1 ; j++) {
                        jsonAjaxStr += "<span class=\"fas fa-star unchecked\"></span>";
                    }
                    jsonAjaxStr += "<span class=\"fas fa-star-half-alt checked\"></span>";
                    for (let j = 0; j < star - 1 ; j++) {
                        jsonAjaxStr += "<span class=\"fas fa-star checked\"></span>";
                    }
                }
                else {
